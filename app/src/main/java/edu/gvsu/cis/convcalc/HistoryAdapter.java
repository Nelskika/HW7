...
public class HistoryAdapter extends SectionedRecyclerViewAdapter<HistoryAdapter.HeaderViewHolder,
    ...
    public HistoryAdapter(List<HistoryItem> items, OnListFragmentInteractionListener listener, HashMap<String, List<HistoryItem>> dayValues, List<String> sectionHeaders) {
        mListener = listener;
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        return new HeaderViewHolder(view); //here
    }
